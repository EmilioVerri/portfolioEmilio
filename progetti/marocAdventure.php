...
<body>
  ...
  <div class="container">
    <h1>Maroc Adventure Marrakech</h1>
    <img src="../image/logoMaroc.jpeg" alt="Immagine Progetto" title="Immagine Progetto" class="project-image" />
<p class="description" style="margin-top: 40px; color: #ccc;">
  Ho collaborato (senza scopo di lucro) con <strong>Jawad e ZServizi</strong> per la realizzazione del sito <strong>Maroc Adventure Marrakech</strong>. Questo sito è dedicato alle escursioni in Marocco, con proposte autentiche tra deserto, città imperiali e tradizioni locali. È attualmente in fase di sviluppo e verrà completato a breve con tutte le funzionalità e i contenuti.
</p>
...
<div class="github-icon-wrapper">
  <a href="https://marocadventure.altervista.org/" target="_blank" title="Visita il sito" class="visit-button">
