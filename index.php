...
/* Keyframes per far scendere il PC */
@keyframes dropPc {
    0% {
        top: -150px; /* inizio fuori schermo sopra */
    }
    100% {
        top: 100px; /* più in basso di prima, regola questo valore */
    }
}
  ...
  <style>
    ...
    @media (max-width: 600px) {
      ...
      ul.timeline li {
        margin: 30px 0;
        padding-left: 0;
        transform: none !important; /* disabilita animazione su mobile */
        opacity: 1 !important;
      }
      ul.timeline li::before {
        display: none;
